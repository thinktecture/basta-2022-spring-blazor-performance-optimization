...
public partial class Index
{
    ...
    private void ToggleVirtualize(bool virtualize)
    {
        _virtualize = virtualize;
        if (_loadWithItemsProvider && !_virtualize)
        {
            _loadWithItemsProvider = false;
        }
    }

    private void ToggleLoadWithItemsProvider(bool loadWithProvider)
    {
        _loadWithItemsProvider = loadWithProvider;
        if (_loadWithItemsProvider && !_virtualize)
        {
            _virtualize = true;
        }
